/* Comentário de  multi ilnha*/
// Esse é um comentário de apenas um linha 
...
/*
    ...
    - objetivo 2 - quando clicar no botão de troca de tema, caso o body já tenha a classe modo-escuro, remover a classe pra mudar pro modo claro e mudar a imagem pro sol
           6 - Verificar se o Body já tem o modo escuro
...
botaoAlterarTema.addEventListener("click", () => {
    ...
    if (modoEscuroEstaAtivo) {
        ...
        //Aqui adicionamos o toggle para substituir esses itens, posso excluir. 
